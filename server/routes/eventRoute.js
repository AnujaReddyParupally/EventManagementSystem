...
router.post('/admin/add', validateFields, eventctrl.addevent);

router.put('/admin/edit/:id', validateFields, eventctrl.editevent);

router.delete('/admin/delete/:id', eventctrl.deleteevent);
