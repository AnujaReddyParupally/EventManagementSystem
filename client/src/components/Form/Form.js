...
class Form extends Component {
    ...
    //check if OTP is expired
      ...
      axios
        ...
        .catch((err) => {
          ...
          else errorMessages.push(ERRORS.GENERIC_FAILED);
          this.setState({
            ...this.state,
            errorMessages,
            notifications: [],
  ...
  onFormSubmit(event) {
    ...
    if (this.state.isLogin) {
      ...
      if (errorMessages.length === 0) {
        ...
        let loggedinuser = {
          id: "623dd1f1798dafb0d0c6f9f4",
          firstname: "Anuja Reddy",
          lastname: "Parupally",
          email: "subp875@gmail.com",
          role: 0,
        };
  ...
  onForgotPwdSubmit(event) {
    ...
    if (errorMessages.length === 0) {
      ...
      axios
        .post("/api/v1/auth/updatecreds", data, {
          headers: {
            "Content-Type": "application/json",
          },
        })
  ...
  componentDidMount() {
    ...
    if (user && user.id) this.setState({ ...this.state, user });
  }
